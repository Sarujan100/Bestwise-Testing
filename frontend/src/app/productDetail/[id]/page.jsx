...
function ProductDetailPage() {
  ...
  return (
    ...
    <div className='w-full justify-center flex-co pl-[120px] pr-[120px]'>  <Navbar />
      <div className='w-full flex h-auto mt-[20px] bg-amber-500'>
        {/* Left Section - Image & Description */}
        <div className='flex-col justify-center w-[60%] h-[572px] bg-amber-800'>
          ...
          <div className='flex-col items-center mt-[25px] bg-green-500'>
        ...
        <div className='w-[40%] h-auto pl-[20px] bg-amber-300'>
          ...
          <div className='mt-[15px] p-[15px] border rounded-[8px]'>
            ...
            {/* all Products */}
     <div className="flex flex-wrap gap-4 bg-blue-300 mt-[100px]">
