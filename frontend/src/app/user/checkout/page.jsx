                                ...
                                <div key={item.productId} className='w-full flex justify-center mb-[30px]'>
                                    ...
                                    <div className='w-[45%] flex-col'>
                                        <div className='flex items-center space-x-[15px]'>
                                            <p>Quantity</p>
                                            <button
                                                className='w-10 h-10 flex items-center justify-center rounded-full bg-[#822BE2] text-white text-xl font-bold hover:bg-purple-200 hover:text-[#822BE2] hover:border-2 hover:border-[#822BE2] transition-all duration-200'
